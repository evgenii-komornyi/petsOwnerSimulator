...
//        Stats coffeeMinValues = new Stats();
//        coffeeMinValues.setHealth(0);
//        coffeeMinValues.setSatiety(0);
//        coffeeMinValues.setMood(0);
//        coffeeMinValues.setDigestion(0);
//        coffeeMinValues.setToyPlayCount(0);
//        coffeeMinValues.setHydration(150);
//        coffee.setMinValues(coffeeMinValues);
...
//        coffeeMaxValues.setHydration(230);
...
//        coffeeStats.setHydration(coffeeMinValues.getHydration());
...
//        coffeeStatsReducing.setHydration(1);
...
//        lucky.setType(AnimalType.CATS.getAnimalType());
        ...
        String meeshaDehydrated = Generator.generatePathToFile(Constants.LONG_PATH_FORMAT, Constants.ASSETS_CATS_FOLDER, meeshaName, UriType.DEHYDRATED.getUriValue(), Constants.IMAGE_EXT);
        ...
        Image meeshaImage = new Image(meeshaRegularUri, meeshaSad, meeshaSleeping, meeshaDehydrated, meeshaDead, meeshaBlinking);
        ...
        meesha.setCurrentImage(meeshaRegularUri);
        meesha.setAnimation(lickAnimation);
        Stats meeshaMinValues = new Stats();
        meeshaMinValues.setHealth(0);
        meeshaMinValues.setSatiety(0);
        meeshaMinValues.setMood(0);
        meeshaMinValues.setDigestion(0);
        meeshaMinValues.setToyPlayCount(0);
        meeshaMinValues.setHydration(150);
        meesha.setMinValues(meeshaMinValues);
        ...
        meeshaMaxValues.setHydration(230);
        ...
        meeshaStats.setHydration(meeshaMinValues.getHydration());
        ...
        meeshaStatsReducing.setHydration(1);
        meesha.setStatsReducing(meeshaStatsReducing);
        MoodStats meeshaMoodStats = new MoodStats(35, 35, 35, 35, 35);
...
//        picasso.setType(AnimalType.CATS.getAnimalType());
        ...
        String qwertyDehydrated = Generator.generatePathToFile(Constants.LONG_PATH_FORMAT, Constants.ASSETS_CATS_FOLDER, qwertyName, UriType.DEHYDRATED.getUriValue(), Constants.IMAGE_EXT);
        ...
        Image qwertyImage = new Image(qwertyRegularUri, qwertySad, qwertySleeping, qwertyDehydrated, qwertyDead, qwertyBlinking);
        ...
        qwerty.setCurrentImage(qwertyRegularUri);
        qwerty.setAnimation(lickAnimation);
        Stats qwertyMinValues = new Stats();
        qwertyMinValues.setHealth(0);
        qwertyMinValues.setSatiety(0);
        qwertyMinValues.setMood(0);
        qwertyMinValues.setDigestion(0);
        qwertyMinValues.setToyPlayCount(0);
        qwertyMinValues.setHydration(150);
        qwerty.setMinValues(qwertyMinValues);
        ...
        qwertyMaxValues.setHydration(230);
        ...
        qwertyStats.setHydration(qwertyMinValues.getHydration());
        ...
        qwertyStatsReducing.setHydration(1);
        qwerty.setStatsReducing(qwertyStatsReducing);
        MoodStats qwertyMoodStats = new MoodStats(35, 35, 35, 35, 35);
        ...
        String sammyDehydrated = Generator.generatePathToFile(Constants.LONG_PATH_FORMAT, Constants.ASSETS_CATS_FOLDER, sammyName, UriType.DEHYDRATED.getUriValue(), Constants.IMAGE_EXT);
        ...
        Image sammyImage = new Image(sammyRegularUri, sammySad, sammySleeping, sammyDehydrated, sammyDead, sammyBlinking);
        sammyImage.setCurledUp(new RoomPet(sammyCurledUp));
        sammyImage.setSausage(new RoomPet(sammySausage));
        sammy.setImg(sammyImage);
        sammy.setCurrentImage(sammyRegularUri);
        sammy.setAnimation(lickAnimation);
        Stats sammyMinValues = new Stats();
        sammyMinValues.setHealth(0);
        sammyMinValues.setSatiety(0);
        sammyMinValues.setMood(0);
        sammyMinValues.setDigestion(0);
        sammyMinValues.setToyPlayCount(0);
        sammyMinValues.setHydration(150);
        sammy.setMinValues(sammyMinValues);
        ...
        sammyMaxValues.setHydration(230);
        ...
        sammyStats.setHydration(sammyMinValues.getHydration());
        ...
        sammyStatsReducing.setHydration(1);
        sammy.setStatsReducing(sammyStatsReducing);
        MoodStats sammyMoodStats = new MoodStats(35, 35, 35, 35, 35);
...
//        houdini.setType(AnimalType.CATS.getAnimalType());
        ...
        Animal sammyTest = new Cat();
        sammyTest.setId("cat-666");
        sammyTest.setName("Sammy");
        String sammyTestName = sammyTest.getName().toLowerCase();
        String sammyTestRegularUri = Generator.generatePathToFile(Constants.LONG_PATH_FORMAT, Constants.ASSETS_CATS_FOLDER, sammyTestName, sammyTestName, Constants.IMAGE_EXT);
        String sammyTestSad = Generator.generatePathToFile(Constants.LONG_PATH_FORMAT, Constants.ASSETS_CATS_FOLDER, sammyTestName, UriType.SAD.getUriValue(), Constants.IMAGE_EXT);
        String sammyTestSleeping = Generator.generatePathToFile(Constants.LONG_PATH_FORMAT, Constants.ASSETS_CATS_FOLDER, sammyTestName, UriType.SLEEPING.getUriValue(), Constants.IMAGE_EXT);
        String sammyTestBlinking = Generator.generatePathToFile(Constants.LONG_PATH_FORMAT, Constants.ASSETS_CATS_FOLDER, sammyTestName, UriType.BLINKING.getUriValue(), Constants.IMAGE_EXT);
        String sammyTestCurledUp = Generator.generatePathToFile(Constants.LONG_PATH_FORMAT, Constants.ASSETS_CATS_FOLDER, sammyTestName, UriType.CURLED_UP.getUriValue(), Constants.IMAGE_EXT);
        String sammyTestDehydrated = Generator.generatePathToFile(Constants.LONG_PATH_FORMAT, Constants.ASSETS_CATS_FOLDER, sammyTestName, UriType.DEHYDRATED.getUriValue(), Constants.IMAGE_EXT);
        String sammyTestSausage = Generator.generatePathToFile(Constants.LONG_PATH_FORMAT, Constants.ASSETS_CATS_FOLDER, sammyTestName, UriType.SAUSAGE.getUriValue(), Constants.IMAGE_EXT);
        String sammyTestDead = Generator.generatePathToFile(Constants.SHORT_PATH_FORMAT, Constants.ASSETS_DEAD_FOLDER, UriType.LONG_HAIR.getUriValue(), Constants.IMAGE_EXT);
        Image sammyTestImage = new Image(sammyTestRegularUri, sammyTestSad, sammyTestSleeping, sammyTestDehydrated, sammyTestDead, sammyTestBlinking);
        sammyTestImage.setCurledUp(new RoomPet(sammyTestCurledUp));
        sammyTestImage.setSausage(new RoomPet(sammyTestSausage));
        sammyTest.setImg(sammyTestImage);
        sammyTest.setCurrentImage(sammyTestRegularUri);
        sammyTest.setAnimation(lickAnimation);
        Stats sammyTestMinValues = new Stats();
        sammyTestMinValues.setHealth(0);
        sammyTestMinValues.setSatiety(0);
        sammyTestMinValues.setMood(0);
        sammyTestMinValues.setDigestion(0);
        sammyTestMinValues.setToyPlayCount(0);
        ...
        sammyTestMaxValues.setToyPlayCount(5);
        sammyTestMaxValues.setHydration(230);
        sammyTest.setMaxValues(sammyTestMaxValues);
        Stats sammyTestStats = new Stats();
        sammyTestStats.setHealth(sammyTestMaxValues.getHealth());
        sammyTestStats.setSatiety(sammyTestMaxValues.getSatiety());
        sammyTestStats.setMood(sammyTestMaxValues.getMood());
        sammyTestStats.setDigestion(sammyTestMaxValues.getDigestion());
        sammyTestStats.setToyPlayCount(sammyTestMaxValues.getToyPlayCount());
        sammyTestStats.setHydration(1);
        sammyTest.setStats(sammyTestStats);
        Stats sammyTestStatsReducing = new Stats();
        sammyTestStatsReducing.setHealth(1);
        sammyTestStatsReducing.setSatiety(1);
        sammyTestStatsReducing.setMood(1);
        sammyTestStatsReducing.setDigestion(1);
        sammyTestStatsReducing.setToyPlayCount(1);
        sammyTestStatsReducing.setHydration(1);
        sammyTest.setStatsReducing(sammyTestStatsReducing);
        MoodStats sammyTestMoodStats = new MoodStats(35, 35, 35, 35, 35);
        StatsIncreasing sammyTestStatsIncreasing = new StatsIncreasing(1,1,sammyTestMoodStats,60);
        sammyTest.setStatsIncreasing(sammyTestStatsIncreasing);
        sammyTest.setWasTaken(false);
        sammyTest.setBio("Some adult noticed a screaming and hissing box in the hands of a group of the children. One of them said, there is a kitten inside, and mom doesn’t allow to keep it because of the allergies. The adult asked, if it would be then possible to get the kitten. At first children declined the offer, claiming they were planning to build a house for the cat in the basement, but then agreed to exchange it for some money to buy ice-cream. “It’s not very friendly” – they warned handing the box to the new owner – “It scratches and bites”. At the adult’s home kitten was sitting under the couch for almost a week. Sammy is still afraid of loud noises and children, but otherwise it’s one of the loveliest cats in the universe.");
